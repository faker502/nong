...
<!-- 		<div class="m-grid2" @click="$router.push('/share-rule');">
		...
		<div class="part3" style="margin-top:40px;padding-bottom: 40px;">
		   <div class="wd50">
		   		<div @click="goShare()" class="button">普通邀请</div>		   		
		   </div>
		   <div class="wd50">
		   		<div @click="$router.push('/share2')" class="button">特权邀请</div>
		   </div>
		</div>
