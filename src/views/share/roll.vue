<template>
  <div class="page">
	...
	<nav-bar title="幸运转盘" titleColor='#fff' leftIconColor="#fff"  class="nav-top"/>	
    ...
    <div class="part1">
      ...
      <div class="top-head">
		<div class="top-1">
			...
			<div class="top-3">
				<div @click="$router.push('/record_roll')" class="button">抽奖记录</div>
			</div>		
		</div>
		<div class="top-1"></div>
      </div>
      ...
      <div class="container df_c">
		...
		<div class="marquee" v-show="notice">
		  <div class="">
		    <van-notice-bar scrollable background="#dee2c8" color="#555" :text="notice">
			  <template #left-icon>
