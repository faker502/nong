<template>
  <div class="page">
    ...
    <div class="container">
      <div><img src="#" width="100%" height="220px"></div>
      <div class="wrap">  
        ...
        <div class="bottom">
          ...
          <div class="btns df_r">
            <van-button  @click="$router.push('/position');" color="linear-gradient(153.43deg, #A5CCFA 0%, #3476D4 83.33%)"
              class="btn" :disabled="form.status === 1">确认</van-button>
          </div>
        </div>
      </div>
    </div>
