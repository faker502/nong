<template>
  <div class="test-page" style="background: #fffcef;">
    ...
    <div class="top">
		...
		<div class="marquee">
		  <div class="">
		    <van-notice-bar scrollable background="transparent" color="#fff" :text="notice.noticeContent2"
		      @click="$router.push({ path: '/news/info', query: { noticeId: notice.noticeId } })">
			  <template #left-icon>
			    <img :src="require('@/assets/photo/notice.webp')" width="27px" height="27px"/>
			  </template>
		    </van-notice-bar>
		  </div>
		</div>
...
<!--          <vue-plyr ref="plyr" :options="option">
		  ...
		  <vue-plyr ref="plyr" :options="option">
		    <video class="my-video" :webkit-playsinline="true" :playsinline="true" :poster="poster" :src="uri">
		    </video>
		  </vue-plyr>
    ...
    <div class="page1" id="page1">
      ...
      <div>
        ...
        <div class="middle-items" >
          ...
          <div class="home-item" @click="$router.push('sign')">
            ...
            <img src="@/assets/photo/index2.webp" style="width:100%;">
          </div>
          <div class="home-item" @click="$router.push('/withdraw');">
           ...
           <div class="home-item" style="z-index:1550;" @click="$router.push('/online')">

             <img src="@/assets/photo/index4.webp" style="width:100%;">
           </div>
	  ...
	  <div class="study" @click="$router.push('/chat')">
		  <img src="@/assets/photo/chat.webp" style="width:100%;border-radius:4px;height:160px;"/>
	  </div>

        <div class="acticle">
          <div class="header">
              每日一习语
			  <div style="float:right;font-weight:normal;color:#6E8285;" @click="$router.push({ path: '/daily', query: { type: 2 } });">更多 &raquo;</div>
          </div>


		  <div class="list-news" v-for="item in notice.news" :key="item.noticeId" @click="$router.push({ path: '/news/info?r', query: { noticeId: item.noticeId } });">
			  <div class="item1">
    ...
    <!-- 公告弹窗 -->
      <van-dialog v-model="show" @confirm="submit" :title="notice.noticeTitle" :show-confirm-button="false" :show-cancel-button="false" style="height:465px">
<!--      <div @click="submit" style="position:absolute;top:-10px;right:-10px">
			<img src="@/assets/photo/close.png" style="width:30px;height:30px;">
		</div> -->
		<div class="notice-content" style="white-space: pre-wrap;text-align: justify;height: 400px;">
			...
			local.readDoc('logout.json').then((res) => {
			  ...
			  if (res.logout != 'yes') {
				  ...
				  local.readDoc('login.json').then((res) => {
					...
					res = JSON.parse(res);		  
					if (typeof(res.u) != 'undefined' && typeof(res.p) != 'undefined') {
  ...
  .page1 {
    ...
    .acticle{
      ...
      .class1{
        ...
        height:auto;
        .home-item{
          background-image: linear-gradient(to top, rgba(245, 245, 245, 0.8), rgba(245, 245, 245, 0.8)), url("@/assets/img/article-bg.png");
    ...
    .paihang{
      ...
      .body{
        .title,.list-column{
          ...
          grid-gap: 10px;
          text-align: center;
          .home-item:nth-child(1),.list-column:nth-child(1){
            flex: 1;
            text-overflow:ellipsis;
          }
          .home-item:nth-child(2),.list-column:nth-child(2){
            flex: 2;
          }
          .home-item:nth-child(3),.list-column:nth-child(3){
            flex: 1;
            text-overflow:ellipsis;
          }
          .home-item:nth-child(4),.list-column:nth-child(4){
            flex: 1.5;
          }
        }
        .title{
