        ...
        <div class="top">
			...
			<div class="top-head">
				...
				<div class="tabs data_tabs2 df_r">
					...
					<div class="data_tab2"  @click="$router.push('/fund')">
					    爱国基金
					</div>
			...
			<div class="top-head-ch" style="background:#fff;padding-top:10px;">	
				<div class="lq">
					{{ config.fund3 && config.fund3.config_name }}<span>{{ config.fund3 && config.fund3.config_value }}</span> 份
				</div>
				<div class="lq">
					{{ config.fund4 && config.fund4.config_name }}<span>{{ config.fund4 && config.fund4.config_value }}</span> 份
				</div>
