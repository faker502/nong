        ...
        <div class="top">
			...
			<div class="top-head">
				...
				<div class="tabs data_tabs2 df_r">
					...
					<img src="@/assets/photo/b4.webp" style="width:100%;">
...
<!--                        <div class="header">
                        ...
                        <div class="body">
							...
							<div class="f-1">
								<div class="a-l a-b">{{ item.name }}</span></div>
								<div class="a-l a-b">{{ item.title }}</span></div>
								...
								<div class="a-l a-c">{{ item.more }}</div>
							</div>						
							<div class="f-1" style="margin-top: 10px;">
								<div class="a-l">
									
									<van-button @click="buyProject(item.tip,item.id)">领取</van-button>
