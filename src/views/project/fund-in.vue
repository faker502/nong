    ...
    <div class="test-page">
        ...
        <div class="top">
			...
			<div class="top-head">
				...
				<div class="right-m" @click="$router.push({ path: '/fund/record3'})">领取记录</div>
            ...
            <div class="content">
                <div class="content-box">
                    ...
                    <div class="list" v-for="(item, key) in all" :key="key">
                       <div class="header">
						    <div v-if="key == 0" v-html="gg"></div>
                            <img :src="item.img" style="width:95%;margin-top: 10px;">
                        </div>
                        <div class="body">
							
							<div class="f-1">
								
								<div v-show="item.small" style="position:absolute;height:70px;width:70px;right:80px;">
									<img src="@/assets/photo/3h.webp" style="width:70px;">
								</div>
								
								<div class="a-l a-b">{{ item.name }}</div>
								<div class="a-l a-bb">
									<div style="text-align: left;"><img src="@/assets/photo/a/je.webp" style="width:62px;"></div>
									<div style="position: absolute;right: 20px;top:0;" v-show="item.money == '0'">
										<img src="@/assets/photo/mf.webp" style="width:90px;">
									</div>
									<div style="position: absolute;right: 20px;top:3px;" v-show="item.money != '0'">{{ item.title }}</div>
								</div>
								...
								<div class="a-l a-c" style="margin-top: 10px;" v-html="item.more"></div>
							</div>						
