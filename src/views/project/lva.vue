<template>
    <div class="test-page">
		...
		<nav-bar :title="tit" titleColor='#fff' leftIconColor="#fff"  class="nav-top"/>	
        ...
        <div class="top">
			...
			<div class="top-head">
				...
				<div class="tabs data_tabs2 df_r">
					...
					<img src="@/assets/photo/da.webp?1" style="width:100%;" />

				 
				</div>
			<div class="top-head-ch" style="padding-top:20px;position:relative;height:160px;margin-bottom: 10px;">	
	
				<img src="@/assets/photo/lv0.webp" style="height: 160px; width: 100%;box-shadow: rgba(225, 225, 225, 0.5) 0 5px 10px 0;border-radius: 8px;">
				<div style="line-height: 30px;height: 30px;text-align: left;text-indent: 15px;color:#333;margin-top: -130px; font-size: 32px;
				font-weight: 600;color: rgba(25, 33, 40, 1);text-align: left;letter-spacing: 5px; display: grid;grid-template-columns: 50% 40%;">
					<div style="text-align:left;line-height: 120px;">
						{{ lvText }}
					</div>
            ...
            <div class="content">
                <div class="content-box">
                    ...
                    <div class="list" v-for="(item, key) in list" :key="key">
						<div class="header" @click="getAward(item.num)">
						     <img :src="item.img" style="width:100%;margin-top: 10px;box-shadow: rgba(225, 225, 225, 0.5) 0 5px 10px 0;border-radius: 8px;">
						 </div>
<!--                        <div class="body">
							...
							<div class="f-1">
								...
								<div style="display:block;line-height:30px;height:30px;text-indent:8px;">
									<p>{{ item.title }}</p>
									<p>{{ item.tip }}</p>
								</div>	
							...
							<div class="f-1">
								...
								<div  style="line-height:60px;">
									<van-button  round block type="default" >{{ item.btn }}</van-button>
								</div>
...
import { getListApi3333, getDetailApi, buyProjectApi, getAwardApi3333 } from "@/api/project";
...
export default {
    ...
    methods: {
		getAward(num) {
			getAwardApi3333({'num':num}).then((res) => {
				Toast(res.msg);	
				if (res.code == 200) {					
					this.getProjectList();
				}			
        ...
        getProjectList() {
            getListApi3333({'type':1}).then((res) => {
                this.all = res.data;
