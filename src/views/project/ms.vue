    ...
    <div class="test-page">
        ...
        <div class="top">
			...
			<div class="top-head">
				...
				<div class="right-m" @click="$router.push({ path: '/ms-rec'})">领取记录</div>
...
<!-- 		  <div class="buy-div">	
            ...
            <div class="content">
                <div class="content-box">
					...
					<div style="background:#fff;margin:0 auto 15px auto;border-radius:6px;" v-html="gg"></div> 
					
                    <div class="list" v-for="(item, key) in all" :key="key">
                       <div class="header">
						    
							<div style="font-weight: 600;font-size: 18px;color:rgba(14, 37, 41, 1);text-align:left;padding:10px 15px;">{{ item.name }}</div>
                            <img :src="item.img" style="width:95%;margin-top: 10px;border-radius:8px;">
                        </div>
                        <div class="body">
							
							<div class="f-1">
								
<!-- 								<div v-show="key != 0" style="position:absolute;height:70px;width:70px;right:80px;">
									<img src="@/assets/photo/2h.webp" style="width:70px;">
								</div> -->
								
								<!-- <div class="a-l a-b">{{ item.name }}</div> -->
								<div class="a-l a-bb">
									<div style="text-align: left;"><img src="@/assets/photo/ms/t1.webp" style="height:30px;"></div>						
									<div style="position: absolute;right: 20px;top:3px;">{{ item.title }}</div>
								</div>
								
								<div class="a-l a-bb">
									<div style="text-align: left;"><img src="@/assets/photo/ms/t2.webp" style="height:30px;"></div>						
									<div style="position: absolute;right: 20px;top:3px;">{{ item.daysIncome }}</div>
								</div>
								
								<div class="a-l a-bb">
									<div style="text-align: left;"><img src="@/assets/photo/ms/t3.webp" style="height:30px;"></div>						
									<div style="position: absolute;right: 20px;top:3px;">{{ item.daily }}</div>
								</div>
								
								<div class="a-l a-bb">
									<div class="a-l a-c" style="margin:10px 10px 10px 0;" v-html="item.more"></div>
								</div>
								
								<div class="a-l a-c">
									
									<div style="display:block;line-height:25px;height:25px;padding-top: 5px;">
										<div class="proc" style="padding-top: 8px; width: 95%;">
											<van-progress
											  stroke-width="8" 
								...
								<div class="a-l">
									<div class="a-l a-c" style="margin:10px 10px 10px 0;" v-html="item.remark"></div>
								</div>
								
							</div>						
							<div class="f-1" style="margin-top: 10px;">
								<div class="a-ccc">
									
									<van-button @click="buyProject(item.tip,item.id)"></van-button>
...
import { getListApi, getDetailApi, buyProjectApi } from "@/api/fund";
							...
							.a-ccc {
								...
								.van-button {
												  ...
												  // border: 1px solid #b0be6b;
														...
														background: url('@/assets/photo/ms/btn.webp') no-repeat;
