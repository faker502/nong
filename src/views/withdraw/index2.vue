  ...
  <div class="page">
    <div class="part_1">
      ...
      <div class="info_box">
		...
		<div class="detail-1" style="border: 1px #999 dashed;" v-show="isYuShen">
		  <div class="detail-2">
			  <div class="flex-item">
...
import { getConfigPay2 } from "@/api/index";
  ...
  methods: {
    ...
    getConfigPay() { 
      getConfigPay2().then((res) => { 
        ...
        this.txStartTime = res.data.txStartTime2;
        this.txEndTime = res.data.txEndTime2;
    ...
    async handleWithdraw() {
      ...
      this.isSubmit = false;
      withdrawalApi({ money: this.money, payPassword: this.form.payPwd, type:'fund2' }).then((res) => {
        this.isSubmit = true;
        this.loading = false;
        if (res.code == 200) {
          this.account();
