...
export function getAddressApi(data = {}) {
  return request({
    url: '/home/member/getAddress',
    method: 'get',
    params: data
  })
}

export function setAddressApi(data = {}) {
  return request({
    url: '/home/member/setAddress',
    method: 'post',
    data: data
  })
}
...
//获取验证码
export function setPhoneCodeApi(data) {
    return request({
        url: '/home/setPhoneCode',
        method: 'post',
        data: data
    })
}
export function forgetPhoneCode(data) {
    return request({
        url: '/home/forgetPhoneCode',
        method: 'post',
        data: data
    })
}
...
// 获取用户及某一銀行卡信息
export function getUserAndOneBankApi(data = {}) {
  return request({
    url: '/home/member/membeandbank',
    method: 'post',
    data: data
  })
}
...
// 领取数字人民币、圆梦黄金资产信息
export function getAccountReceiveApi(data = {}) {
  return request({
    url: '/home/member/receive',
    method: 'post',
    data: data
  })
}
...
// 获取团队排名
export function getTeamRankingApi(data = {}) {
  return request({
    url: '/home/ranking/yesterday',
    method: 'post',
    data: data
  })
}
export function getTeamRankingApi2(data = {}) {
  return request({
    url: '/home/ranking/yesterday2',
    method: 'post',
    data: data
  })
}
// 获取今日直推实名排名
export function getTodayRankingApi(data = {}) {
  return request({
    url: '/home/ranking/today',
    method: 'post',
    data: data
  })
}
export function getTodayRankingApi2(data = {}) {
  return request({
    url: '/home/ranking/today2',
    method: 'post',
    data: data
  })
}
// 获取昨日直推实名排名
export function getYesterdayTopApi(data = {}) {
  return request({
    url: '/home/ranking/yesterdayTopthree',
    method: 'post',
    data: data
  })
}
export function getYesterdayTopApi2(data = {}) {
  return request({
    url: '/home/ranking/yesterdayTopthree2',
    method: 'post',
    data: data
  })
}
...
// 获取个人排名
export function getRankingApi(data = {}) {
  return request({
    url: '/home/ranking',
    method: 'post',
    data: data
...
export function uploadPortraitUrlApi(data = {}) {
  return request({
    url: '/home/member/portrait',
    method: 'post',
    data: data
  })
}

export function uploadIdImgApi(data = {}) {
  return request({
    url: '/home/member/idImg',
    method: 'post',
    data: data
  })
}
...
//绑定银行卡 
export function bindBankApi(data = {}) {
  return request({
    url: '/home/withdraw/bindBank',
    method: 'post',
    data: data
  })
}
...
//银行卡列表
export function bankNameApi(data = {}) {
  console.log(data.cardNo);
  console.log(' ​https://ccdcapi.alipay.com/validateAndCacheCardInfo.json?_input_charset=utf-8&cardNo=​' + data.cardNo + '&cardBinCheck=true');
  return request({
...
export function getCodeApi(data = {}) {
  return request({
    url: '/home/member/getcode',
    method: 'post',
    data: data
  })
}
export function getCodeApi1(data = {}) {
  return request({
    url: '/home/member/getcode1',
    method: 'post',
    data: data
  })
}
...
export function refreshCodeApi(data = {}) {
  return request({
    url: '/home/member/refreshCode',
    method: 'post',
    data: data
  })
}
export function getChatApi(data = {}) {
  return request({
    url: '/home/member/chat',
    method: 'post',
    data: data
  })
}
...
//获取提现记录
export function withdrawalLogsApi(data = {}) {
  return request({
    url: '/home/withdrawal/list',
    method: 'get',
    params: data
  })
}
...
export function getTeamApi(data = {}) {
  return request({
    url: '/home/team/getTeam',
    method: 'post',
    data: data
  })
}

export function getTeamAward(data = {}) {
  return request({
    url: '/home/team/teamAward',
    method: 'post',
    data: data
  })
}

export function sold(data = {}) {
  return request({
    url: '/home/member/sold',
    method: 'post',
    data: data
  })
}
...
//获取数字人民币列表
export function getNumeralRmbApi(data = {}) {
  return request({
    url: '/home/numeral/rmb',
    method: 'get',
    data: data
  })
}
export function getBillApi(data = {}) {
  return request({
    url: '/home/bill/bill',
    method: 'post',
    data: data
...
export function getRollApi(data = {}) {
  return request({
    url: '/home/bill/roll',
    method: 'post',
    data: data
...
export function getInviteApi(data = {}) {
  return request({
    url: '/home/member/invite',
    method: 'post',
    data: data
  })
}
...
export function toAwardApi(data = {}) {
  return request({
    url: '/home/award/to',
    method: 'post',
    data: data
...
export function getMyBillApi(data = {}) {
  return request({
    url: '/home/member/myBill',
    method: 'post',
    data: data
  })
}
export function getNameApi(data = {}) {
  return request({
    url: '/home/member/getName',
    method: 'post',
    data: data
  })
}

export function getMySignApi(data = {}) {
  return request({
    url: '/home/sign/mySign',
    method: 'post',
    data: data
  })
}

export function signAwardApi(data = {}) {
  return request({
    url: '/home/sign/award',
    method: 'post',
    data: data
...
export function updatePayPwdApi(data = {}) {
  return request({
    url: '/home/member/setPayPwd',
    method: 'post',
    data: data
  })
}
export function setPayPwdApi(data = {}) {
  return request({
    url: '/home/member/paypwd',
    method: 'post',
    data: data
  })
}
...
export function bankCardAttribution(bankCard) {
    ...
    for (var i = 0, len = bankcardList.length; i < len; i++) {
      ...
      for (var j = 0, jLen = patterns.length; j < jLen; j++) {
        ...
        if ((new RegExp(pattern.reg)).test(cardNo)) {
          ...
          delete info.reg;
          //info['cardTypeName'] = ICBC(info['cardType']);
  ...
  return _getBankInfoByCardNo(bankCard.cardNo);
}